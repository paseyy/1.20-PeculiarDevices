...
public class GeoGeneratorScreen extends BaseDeviceScreen<GeoGeneratorMenu> {
    ...
    public void render(GuiGraphics pGuiGraphics, int pMouseX, int pMouseY, float pPartialTick) {
        ...
        pGuiGraphics.drawString(font, energyStoredText, this.leftPos + 34, this.topPos + 29, 0x6666FF, false);
        pGuiGraphics.drawString(font, energyGeneratedText, this.leftPos + 34, this.topPos + 40, 0x6666FF, false);
    }
